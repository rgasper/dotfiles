...
put your summary in docs/explain/. create a mermaid diagram of the high level flow and connections to relevant components/services/dependencies - preview it using the mermaid mcp.
